...
RUN mkdir /inflowbot-backend
WORKDIR /inflowbot-backend
ADD Gemfile /inflowbot-backend/Gemfile

ADD Gemfile.lock /inflowbot-backend/Gemfile.lock
RUN bundle install
ADD . /inflowbot-backend
